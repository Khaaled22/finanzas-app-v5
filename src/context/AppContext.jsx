...
function AppContextComposer({ children, currentUser, displayCurrency, setDisplayCurrency }) {
  ...
  const value = useMemo(() => ({
    ...
    transactionsCtx.addTransactionsBatch,
    transactionsCtx.updateTransaction,
    transactionsCtx.deleteTransaction,
    transactionsCtx.clearAllTransactions,
    transactionsCtx.transactionIndex,
    transactionsCtx.getTransactionsByMonth,
    transactionsCtx.getTransactionsByCategoryAndMonth,
    // ExchangeRatesContext
    ratesCtx.exchangeRates,
    ratesCtx.autoUpdateConfig,
    ratesCtx.convertCurrency,
    ratesCtx.convertCurrencyAtDate,
    ratesCtx.getRateForDate,
    ratesCtx.updateExchangeRates,
    ratesCtx.importHistoricalRates,
    ratesCtx.fetchExchangeRates,
    ratesCtx.setAutoUpdateEnabled,
    ratesCtx.setUpdateInterval,
    ratesCtx.syncFromSupabase,
    ratesCtx.syncStatus,
    // BudgetContext
    budgetCtx.categories,
    budgetCtx.monthlyBudgets,
    budgetCtx.selectedBudgetMonth,
    budgetCtx.ynabConfig,
    budgetCtx.categoriesWithMonthlyBudget,
    budgetCtx.getCategoryBudgetForMonth,
    budgetCtx.getCategorySpentForMonth,
    budgetCtx.initializeCategoryForMonth,
    budgetCtx.updateMonthlyBudget,
    budgetCtx.copyBudgetFromPreviousMonth,
    budgetCtx.copyBudgetToNextMonths,
    budgetCtx.clearMonthlyBudgets,
    budgetCtx.transferBetweenCategories,
    budgetCtx.updateCategory,
    budgetCtx.deleteCategory,
    budgetCtx.importCategories,
    // InvestmentsContext
    investmentsCtx.investments,
    investmentsCtx.savingsGoals,
    investmentsCtx.savePlatform,
    investmentsCtx.deletePlatform,
    investmentsCtx.archivePlatform,
    investmentsCtx.restorePlatform,
    investmentsCtx.updatePlatformBalance,
    investmentsCtx.calculatePlatformROI,
    investmentsCtx.cashPlatforms,
    investmentsCtx.investmentPlatforms,
    // DebtsContext
    debtsCtx.debts,
    debtsCtx.addDebt,
    debtsCtx.updateDebt,
    debtsCtx.deleteDebt,
    debtsCtx.registerDebtPayment
  ]);
