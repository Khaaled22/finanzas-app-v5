                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2 text-sm text-gray-500">
                        ...
                        {trans.recurrence === 'monthly' && (
                          <>
                            <span>•</span>
                            <span className="px-1.5 py-0.5 bg-blue-100 text-blue-700 rounded text-xs" title={trans.autoGenerated ? 'Generada automáticamente' : 'Plantilla recurrente'}>
                              {trans.autoGenerated ? '↻ Auto' : '↻ Mensual'}
                            </span>
                          </>
                        )}
                        {trans.paymentMethod && (
