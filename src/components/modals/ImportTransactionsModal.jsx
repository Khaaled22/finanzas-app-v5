...
import TransactionImporter from '../../utils/TransactionImporter';

export default function ImportTransactionsModal({ isOpen, onClose }) {
  const { addTransactionsBatch, clearAllTransactions } = useApp();
  ...
  const handleProcessFile = async () => {
    ...
    try {
      const result = await TransactionImporter.processFile(file);
          ...
          <div className="space-y-6">
            ...
            <div className="bg-blue-50 border-2 border-blue-200 rounded-lg p-4">
              ...
              <ul className="text-sm text-blue-800 space-y-1">
                ...
                <li>• <strong>Configuración:</strong> Usuario = "Usuario 1", Método pago = "Tarjeta"</li>
              </ul>
            </div>
            ...
            <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center hover:border-blue-500 transition-colors">
              ...
              {!file ? (
                ...
                <div>
                  <i className="fas fa-file-excel text-6xl text-green-500 mb-4"></i>
                  <p className="text-lg font-medium text-gray-700 mb-2">
                    {file.name}
                  </p>
